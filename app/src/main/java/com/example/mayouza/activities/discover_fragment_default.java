...
public class discover_fragment_default extends Fragment {

    private static discover_fragment_default instance = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        title.setText(getResources().getString(R.string.DiscoverAsssessment_categoryName3));
    ...
    public static discover_fragment_default newInstance(String title , String desc , int imgID){

        if(instance == null){
            // new instance
            instance = new discover_fragment_default();
